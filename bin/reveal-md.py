...
parser = argparse.ArgumentParser(description="Convert your markdown to presentation")

parser.add_argument(
    "-dir", metavar="-d", type=str, nargs="+", help="Directory of your markdown files"
)
parser.add_argument("-config", metavar="-c", type=str, nargs="+", help="Config file")
...
if args.dir:
    if isdir(args.dir[0]):
        file_names = [
            file for file in listdir(args.dir[0]) if isfile(join(args.dir[0], file))
        ]
