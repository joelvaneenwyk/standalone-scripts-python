...
def create():
    def sub_create():
        def sub1():
            ...
            l1 = tkinter.Label(
                f1,
                text="Congratulations! Your Entry Is Made.",
                bg="#330033",
                fg="#FFFFFF",
                relief="groove",
                pady=30,
            ...
            b1 = tkinter.Button(
                ...
                fg="blue",
                relief="groove",
                command=combine_funcs(sub2, start),
                height=2,
                width=25,
            )
            b1.pack(side="right")
        ...
        b1 = tkinter.Button(
            f2, text="Submit", bg="#FFFFFF", fg="blue", relief="groove", command=sub1
        )
        b1.pack()
...
def get():
    def sub_get():
        ...
        l1 = tkinter.Label(
            f2,
            text="Your Entries For The Date " + a + " Are: ",
            bg="#FFFFFF",
            fg="#680000",
            relief="groove",
            anchor="center",
...
def getm():
    def sub_getm():
        ...
        l1 = tkinter.Label(
            f2,
            text="Your Entries For The Month Are: ",
            bg="#FFFFFF",
            fg="#680000",
            relief="groove",
            anchor="center",
...
def Sum():
    def sub_Sum():
        ...
        try:
            ...
            l1 = tkinter.Label(
                f2,
                text="No Such Entry Is Made " + t + " Are: \nRs " + str(c),
                bg="#FFFFFF",
                fg="#680000",
                relief="groove",
                anchor="center",
...
def delete():
    ...
    def sub_delete():
        ...
        l1 = tkinter.Label(
            f2,
            text="Congratulations! Your Entry Is Deleted.",
            bg="#330033",
            fg="#FFFFFF",
            relief="groove",
            pady=30,
...
def start():
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Create A new Entry",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Get Entry By Date",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Get Entry By Month",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Get Total Expense On Date",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    b1 = tkinter.Button(
        frame,
        text="Get Total Expense On Date",
        bg="#9999FF",
        fg="#660099",
        relief="solid",
        command=Sum,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Get Total Expense In A Month",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Add To Existing Entry",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
    ...
    l1 = tkinter.Label(
        frame,
        text="Press To Delete Existing Entry",
        bg="#330066",
        fg="#66FFFF",
        relief="groove",
        pady=15,
